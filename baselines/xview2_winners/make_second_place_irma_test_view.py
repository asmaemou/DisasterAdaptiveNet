...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_irma")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_irma_TEST_ONLY")
...
print("Created Hurricane Irma TEST_ONLY folder")
print("TEST:", TEST)
