...
DORIAN = Path("/homes/j244s673/documents/wsu/phd/hurricane_dorian_preprocessed")
TEST_IMAGES = DORIAN / "test" / "images"
TEST_MASKS = DORIAN / "test" / "masks"

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baselines/second_place_hurricane_dorian_ZERO_SHOT_full_solution")
...
def main():
    ...
    print("================================================")
    print("ZERO-SHOT xView2 2nd-place full available ensemble on Hurricane Dorian")
    print("No Dorian fine-tuning is performed.")
    print("================================================")
    ...
    with open(OUT / "metrics_summary.txt", "w") as f:
        f.write("2nd-place xView2 full available ensemble ZERO-SHOT on Hurricane Dorian\n")
        f.write("No Hurricane Dorian fine-tuning used.\n\n")
