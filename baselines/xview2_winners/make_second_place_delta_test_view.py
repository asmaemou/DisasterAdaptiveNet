...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_delta")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_delta_TEST_ONLY")
...
print("Created Hurricane Delta TEST_ONLY folder")
print("TEST:", TEST)
