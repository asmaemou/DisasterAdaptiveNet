...
SRC = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/third_place_mount_semeru_TEST_ONLY")
OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/first_place_mount_semeru_TEST_ONLY")
...
print("Prepared Mount Semeru TEST_ONLY for 1st-place xView2 code")
print("SRC:", SRC)
print("OUT:", OUT)
