...
SRC_CANDIDATES = [
    Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/third_place_texas_tornadoes_TEST_ONLY"),
    Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_texas_tornadoes_TEST_ONLY"),
]

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/first_place_texas_tornadoes_TEST_ONLY")

SRC = next((p for p in SRC_CANDIDATES if p.exists()), None)
if SRC is None:
    print("Could not find Texas Tornadoes TEST_ONLY source dataset. Checked:")
...
print("Prepared Texas Tornadoes TEST_ONLY for 1st-place xView2 code")
print("SRC:", SRC)
print("OUT:", OUT)
