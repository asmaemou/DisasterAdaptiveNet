...
DATASET = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_stvincent_volcano_TEST_ONLY")
TEST_IMAGES = DATASET / "images"
TEST_MASKS = DATASET / "masks"
PRED_SIZE = 512

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baselines/second_place_stvincent_volcano_TEST_ONLY_ZERO_SHOT_full_solution")
...
def main():
    ...
    print("================================================")
    print("ZERO-SHOT xView2 2nd-place full available ensemble on St. Vincent Volcano TEST")
    print("No St. Vincent Volcano TEST fine-tuning is performed.")
    print("================================================")
    ...
    with open(OUT / "metrics_summary.txt", "w") as f:
        f.write("2nd-place xView2 full available ensemble ZERO-SHOT on St. Vincent Volcano TEST\n")
        f.write("No St. Vincent Volcano TEST fine-tuning used.\n\n")
