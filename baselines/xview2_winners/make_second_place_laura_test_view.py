...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_laura")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_laura_TEST_ONLY")

df = pd.read_csv(FULL / "folds.csv")

if "split" not in df.columns:
    raise SystemExit("ERROR: folds.csv has no split column.")
...
print("Created Hurricane Laura TEST_ONLY folder")
print("TEST:", TEST)
