...
SRC = Path("/homes/j244s673/documents/wsu/phd/hurrican-ian")
OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_ianbd")
...
print("Prepared second-place IAN-BD dataset:")
print("SRC:", SRC)
print("OUT:", OUT)
