...
SRC = Path("/homes/j244s673/documents/wsu/phd/stvincent_volcano_preprocessed")
OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_stvincent_volcano")
...
print("Prepared St. Vincent Volcano for 2nd-place xView2 code")
print("SRC:", SRC)
print("OUT:", OUT)
print()
print("Split counts:")
