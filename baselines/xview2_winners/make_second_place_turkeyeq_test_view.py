...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_earthquake_turkey")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_earthquake_turkey_TEST_ONLY")
...
print("Created TEST_ONLY folder")
print("TEST:", TEST)
