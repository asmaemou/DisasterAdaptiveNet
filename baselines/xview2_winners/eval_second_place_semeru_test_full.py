...
def main():
    ...
    if args.dataset == "pakistan_flooding":
        dataset_slug = "pakistan_flooding"
        dataset_label = "Pakistan Flooding"
        short_label = "Pakistan Flooding"
    elif args.dataset == "hurricane_delta":
