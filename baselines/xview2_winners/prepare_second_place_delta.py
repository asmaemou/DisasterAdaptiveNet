...
SRC = Path("/homes/j244s673/documents/wsu/phd/hurricane_delta_preprocessed")
OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_delta")
...
print("Prepared Hurricane Delta for 2nd-place xView2 code")
print("SRC:", SRC)
print("OUT:", OUT)
print()
print("Split counts:")
