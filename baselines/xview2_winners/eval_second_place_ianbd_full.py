...
DATASET = Path("/homes/j244s673/documents/wsu/phd/hurrican-ian")
...
FT_EXP = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baselines/second_place_ianbd_FULL_SOLUTION_finetune")
...
def main():
    ...
    if args.mode == "zeroshot":
        OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baselines/second_place_ianbd_ZERO_SHOT_full_solution")
        label = "2nd-place xView2 full available ensemble ZERO-SHOT on IAN-BD"
    else:
        OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baselines/second_place_ianbd_FULL_SOLUTION_finetune_test_eval")
        label = "2nd-place xView2 full available ensemble FINE-TUNED on IAN-BD"
