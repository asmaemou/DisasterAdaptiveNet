...
SRC = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_stvincent_volcano_TEST_ONLY")

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/third_place_stvincent_volcano_TEST_ONLY")
...
print("Prepared St. Vincent Volcano TEST_ONLY for 3rd-place xView2 code")
