...
SRC = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_hurricane_delta_TEST_ONLY")

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/third_place_hurricane_delta_TEST_ONLY")
...
print("Prepared Hurricane Delta TEST_ONLY for 3rd-place xView2 code")
