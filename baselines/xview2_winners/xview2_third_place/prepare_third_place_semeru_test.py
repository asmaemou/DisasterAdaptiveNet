...
SRC = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_mount_semeru_TEST_ONLY")

OUT = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/third_place_mount_semeru_TEST_ONLY")
...
print("Prepared Mount Semeru TEST_ONLY for 3rd-place xView2 code")
