...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_stvincent_volcano")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_stvincent_volcano_TEST_ONLY")
...
print("Created St. Vincent Volcano TEST_ONLY folder")
print("TEST:", TEST)
