...
FULL = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_pakistan_flooding")
TEST = Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/output/xview2_baseline_datasets/second_place_pakistan_flooding_TEST_ONLY")
...
print("Created Pakistan Flooding TEST_ONLY folder")
print("TEST:", TEST)
