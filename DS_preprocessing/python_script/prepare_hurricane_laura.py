...
# Dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/HURRICANE-LAURA")
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/hurricane_laura_preprocessed")
...
print(f"Prepared Hurricane Laura dataset at: {OUT_ROOT}")
