...
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/HURRICANE-DORIAN")
...
if (RAW_ROOT / "images").exists() and (RAW_ROOT / "masks").exists():
    ...
    raise FileNotFoundError(
        ...
        "Expected either HURRICANE-DORIAN/images and HURRICANE-DORIAN/masks "
        "or HURRICANE-DORIAN/data/images and HURRICANE-DORIAN/data/masks."
    )

IMG_DIR = DATA_ROOT / "images"
MSK_DIR = DATA_ROOT / "masks"

OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/hurricane_dorian_preprocessed")
...
print(f"Prepared Hurricane Dorian dataset at: {OUT_ROOT}")
