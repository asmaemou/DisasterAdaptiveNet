...
# Dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/TONGA-VOLCANO")
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/tonga_volcano_preprocessed")
...
print(f"Prepared Tonga Volcano dataset at: {OUT_ROOT}")
