...
# Dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/TEXAS-TORNADOES")
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/texas_tornadoes_preprocessed")
...
print(f"Prepared Texas Tornadoes dataset at: {OUT_ROOT}")
