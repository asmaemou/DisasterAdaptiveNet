...
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/PAKISTAN-FLOODING")
...
if (RAW_ROOT / "images").exists() and (RAW_ROOT / "masks").exists():
    ...
    raise FileNotFoundError(
        ...
        "Expected either PAKISTAN-FLOODING/images and PAKISTAN-FLOODING/masks "
        "or PAKISTAN-FLOODING/data/images and PAKISTAN-FLOODING/data/masks."
    )

IMG_DIR = DATA_ROOT / "images"
MSK_DIR = DATA_ROOT / "masks"

OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/pakistan_flooding_preprocessed")
...
print(f"Prepared Pakistan Flooding dataset at: {OUT_ROOT}")
