...
# Dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/EARTHQUAKE-TURKEY")
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/earthquake_turkey_preprocessed")
...
print(f"Prepared Earthquake Turkey dataset at: {OUT_ROOT}")
