...
# Dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/MOUNT-SEMERU-ERUPTION")
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/mount_semeru_eruption_preprocessed")
...
print(f"Prepared Mount Semeru Eruption dataset at: {OUT_ROOT}")
