...
# New dataset root
RAW_ROOT = Path("/homes/j244s673/documents/wsu/phd/HURRICANE-DELTA")

# This handles both possible structures:
# 1) HURRICANE-DELTA/images and HURRICANE-DELTA/masks
# 2) HURRICANE-DELTA/data/images and HURRICANE-DELTA/data/masks
if (RAW_ROOT / "images").exists() and (RAW_ROOT / "masks").exists():
    ...
    raise FileNotFoundError(
        ...
        "Expected either HURRICANE-DELTA/images and HURRICANE-DELTA/masks "
        "or HURRICANE-DELTA/data/images and HURRICANE-DELTA/data/masks."
    )
...
# Output folder
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/hurricane_delta_preprocessed")
...
print(f"Prepared Hurricane Delta dataset at: {OUT_ROOT}")
