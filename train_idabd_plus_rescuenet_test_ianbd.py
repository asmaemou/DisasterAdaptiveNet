...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser("Train on IDA-BD + RescueNet-xBD, test on IAN-BD")
    ...
    parser.add_argument("--output-dir", type=str, default="output/idabd_plus_rescuenet_to_ianbd")
