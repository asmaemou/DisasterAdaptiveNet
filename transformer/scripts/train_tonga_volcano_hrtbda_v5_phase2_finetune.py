#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Tonga Volcano.
...
before fine-tuning on the Tonga Volcano dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Tonga Volcano
    xBD-trained Phase II initialization -> fine-tune Phase II on Tonga Volcano
    Validate on Tonga Volcano val
    Test on Tonga Volcano test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Tonga Volcano supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
