#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Texas Tornadoes.
...
before fine-tuning on the Texas Tornadoes dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Texas Tornadoes
    xBD-trained Phase II initialization -> fine-tune Phase II on Texas Tornadoes
    Validate on Texas Tornadoes val
    Test on Texas Tornadoes test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Texas Tornadoes supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
