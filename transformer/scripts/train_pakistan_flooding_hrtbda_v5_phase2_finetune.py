...
before fine-tuning on the Pakistan Flooding dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Pakistan Flooding
    xBD-trained Phase II initialization -> fine-tune Phase II on Pakistan Flooding
    Validate on Pakistan Flooding val
    Test on Pakistan Flooding test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Pakistan Flooding supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
