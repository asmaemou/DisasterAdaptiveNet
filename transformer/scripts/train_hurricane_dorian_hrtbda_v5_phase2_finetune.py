#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Hurricane Dorian.
...
before fine-tuning on the Hurricane Dorian dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Hurricane Dorian
    xBD-trained Phase II initialization -> fine-tune Phase II on Hurricane Dorian
    Validate on Hurricane Dorian val
    Test on Hurricane Dorian test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Hurricane Dorian supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
