#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Hurricane Laura.
...
before fine-tuning on the Hurricane Laura dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Laura
    xBD-trained Phase II initialization -> fine-tune Phase II on Laura
    Validate on Laura val
    Test on Laura test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Hurricane Laura supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
...
def add_phase2_init_call(text: str) -> str:
    ...
    We insert it immediately before the Phase-II class_weights line because
    at that point the Phase-II model has already been constructed.
    """
