#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Hurricane Delta.
...
before fine-tuning on the Hurricane Delta dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Hurricane Delta
    xBD-trained Phase II initialization -> fine-tune Phase II on Hurricane Delta
    Validate on Hurricane Delta val
    Test on Hurricane Delta test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Hurricane Delta supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
