#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on St. Vincent Volcano.
...
before fine-tuning on the St. Vincent Volcano dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on St. Vincent Volcano
    xBD-trained Phase II initialization -> fine-tune Phase II on St. Vincent Volcano
    Validate on St. Vincent Volcano val
    Test on St. Vincent Volcano test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for St. Vincent Volcano supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
