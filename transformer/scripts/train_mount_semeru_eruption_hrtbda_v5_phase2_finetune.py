#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Mount Semeru Eruption.
...
before fine-tuning on the Mount Semeru Eruption dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Mount Semeru
    xBD-trained Phase II initialization -> fine-tune Phase II on Mount Semeru
    Validate on Mount Semeru val
    Test on Mount Semeru test
"""
...
DATASET_TAG = "mount_semeru_eruption"
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Mount Semeru supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
