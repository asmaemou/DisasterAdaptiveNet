#!/usr/bin/env python3
"""
HRTBDA v5 Phase-II fine-tuning on Hurricane Irma.
...
before fine-tuning on the Hurricane Irma dataset.

Main experiment:
    xBD-trained Phase I initialization -> fine-tune Phase I on Hurricane Irma
    xBD-trained Phase II initialization -> fine-tune Phase II on Hurricane Irma
    Validate on Hurricane Irma val
    Test on Hurricane Irma test
"""
...
def add_phase2_loader_helper(text: str) -> str:
    ...
    helper = r'''
# ---------------------------------------------------------------------
# Added for Hurricane Irma supervised fine-tuning from xBD Phase-II
# ---------------------------------------------------------------------
