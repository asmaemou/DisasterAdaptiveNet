...
This version is modified for your current setup:
- Run/copy this script from /homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/new_approach
...
- OUT_DIR saves fine-tuned checkpoints under DisasterAdaptiveNet/new_approach
...
ZOO_CANDIDATES = [
    ...
    Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet/new_approach"),
    Path("/homes/j244s673/documents/wsu/phd/DisasterAdaptiveNet"),
    Path("/homes/j244s673/documents/wsu/phd/xview2_1st_place_solution/new_approach"),
]
for cand in ZOO_CANDIDATES:
    if (cand / "zoo").is_dir():
        sys.path.insert(0, str(cand))
        print(f"[PATH] Using zoo from: {cand / 'zoo'}")
        break
else:
    print("[PATH] Warning: could not find a zoo/ directory in expected locations.")
