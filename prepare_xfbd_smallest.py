...
SRC_ROOT = Path("/homes/j244s673/documents/wsu/phd/xFBD/data/xfbd/data 3/xfbd/smallest_building")
OUT_ROOT = Path("/homes/j244s673/documents/wsu/phd/xfbd_smallest_disasteradaptivenet")
...
def main():
    ...
    print(f"Prepared xFBD smallest dataset at: {OUT_ROOT}")
