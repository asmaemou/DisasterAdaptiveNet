#!/usr/bin/env python3
"""
HRTBDA v5 + PMKF multi-label rare-crop cascaded transformer experiment.
...
class PMKFBlock(nn.Module):
    ...
    3x3 captures local roof/building texture damage.
    5x5 captures medium-scale partial damage.
    7x7 captures wider collapse/debris context.

    Depthwise-separable convolutions are used to reduce memory cost.
    """
    ...
    def __init__(self, channels: int, branch_channels: Optional[int] = None, dropout: float = 0.10):
        ...
        # Learnable residual strength. Starts small so PMKF does not disturb CSF features too much.
